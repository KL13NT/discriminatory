...
const About = ({ intl: { formatMessage: f, locale } }) => {
	...
	return (
		<>
			...
			<header className='m-header' dir={dir}>
				<div>
					<div className='m-navbar' dir={dir}>
			...
			<section className='c-section forwards' dir={dir}>
			...
			<section className='c-section backwards' dir={dir}>
				<div className='c-section-text'>
					<p>
			...
			<section className='c-section vertical' dir={dir}>
				<div className='c-section-text'>
					<p>
